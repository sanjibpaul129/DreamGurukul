...
<body>
    <div id="light" class="white_content">
        <div class="form-wrap" id="">
            ...
            <form data-toggle="validator" action="dreamgurukul/enquiry_form_submit.php" id="enquire_now" method="post" class="contact-form enquire-form">
            ...
            <script type="text/javascript">
              jQuery(document).ready(function($){
                ...
                {
                    document.getElementById('calling_function').setAttribute('href', "tel:"+mobile.toString());
                }
            });
            </script>
    ...
    <div id="download" class="white_content">
        <div class="form-wrap" id="">
            <div class="cont-desc">Download Brochure Form</div>
            <!-- <form id="enquiryForm" method="POST" class="contact-form enquire-form" novalidate> -->
            <form data-toggle="validator" action="dreamgurukul/download_brochure_submit.php" id="enquire_now" method="post" class="contact-form enquire-form">
                <!-- <input type="hidden" name="utmsource" class="utmSource" value="<?php echo $_GET['utm_source']; ?>">
                <input type="hidden" name="utmcampaign" class="utmCampaign" value="<?php echo $_GET['utm_campaign']; ?>">
                <input type="hidden" name="utmmedium" class="utmMedium" value="<?php echo $_GET['utm_medium']; ?>">
                <input type="hidden" name="utmterm" class="utmTerm" value="<?php echo $_GET['utm_term']; ?>"> -->
            ...
            <div id="enquirySuccess" class="success dark-btn text-center mg-tp-20 pd-bt-20" style="display: none;">Your response has been received. <br> Thank You</div>
        </div> <a class="closebtn" href="javascript:void(0)" onclick="document.getElementById('downlad').style.display='none';document.getElementById('fade').style.display='none'"><img src="assets/images/close.webp" alt="Overview"></a>
    </div>
    ...
    <div class="sticky-btn">
        ...
        <a class="btnbox" href="javascript:void(0)" onclick="document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'">
            ...
            <div class="center pos-rel">
                <div class="centertxt" id ="knowMore" >KNOW MORE</div>
        ...
        <div class="d-inline-block">
        <a class="btnbox" href="javascript:;" onclick="document.getElementById('download').style.display='block';document.getElementById('fade').style.display='block'  id="download-brochure" >
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-12 col-xs-12 " style="height: 50vh;">
                ...
                <h3>
                    <p class="sec-desc text-center" >Your submission is received and we will contact you soon.<br></p>
                    
                    <div class="brochure_theme" id="downloadBrochureButton">
                       <a href="https://onedrive.live.com/download?resid=3F3CF1D351D4BABC%21758&authkey=!AOKd29YXCl26os0&em=2" ><i  class="fas fa-download brochure_download_icon" ></i></a>
                        <a  href="https://onedrive.live.com/download?resid=3F3CF1D351D4BABC%21758&authkey=!AOKd29YXCl26os0&em=2"><input type ="button" class ="brochure_download_btn" value = "Click To Download Brochure" >
                         </a><br><br>
                    </div>
                        ...
                        if (respond_message != "") {
                            ...
                            if (download_brochure == 1) {
                                ...
                                link.click();
                                    ...
                                    window.location.href = "download_brochure_thankyou.php";
                            }
                        }
                    },
