        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-xs-12 " style="height: 50vh;">
                <h2 class="text-reg text-center">
                    ...
                    <div class="sec-subdesc text-center thankyou" style="display: block;"><span>Thankyou!</span></div>
                </h2>
                <h3>
                    <p class="sec-desc text-center yourResponse" >Your response has been received.
